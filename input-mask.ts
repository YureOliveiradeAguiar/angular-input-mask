...
/**
 * @class The directive that allows the use of the html attribute `mask=""`
 * and implements the angular control value accessor (CVA).
 *
 * ### Supported tokens
 * | Token | Description |
 * |------|-------------|
...
export class InputMask implements ControlValueAccessor {
  ...
  /**
   * Gets the real max length of the mask by exclusively counting its mask tokens
   * (N for numbers, L for letters..).
   * @example
   * - Mask: `NNN-LLLL`
